...
//		String result = passwordEncoder.encode(sh1Password);
		...
		if (CollectionUtils.isNotEmpty(userDetails.getRoles())) {
			...
			for (ERole role : userDetails.getRoles()) {

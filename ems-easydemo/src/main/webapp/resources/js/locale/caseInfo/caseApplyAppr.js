...
$(function(){
    ...
    $('#insidetabsdiv').tabs('update', {
        tab: tab0,
        options: {
            href: basepath+"/caseInfo/caseApplyCheckInfoAppr?applyCode="+applyCode+"&period="+period,  // the new content URL
        }
    });
    tab0.panel('refresh', basepath+"/caseInfo/caseApplyCheckInfoAppr?applyCode="+applyCode+"&period="+period);
